...
const CreatePost = () => {
  ...
  return (
    <div className="new-post-container">
      <p className="large-welcome">Create a listing</p>
      <form onSubmit={createNewPost} className="form">
        ...
        <svg class="svg-icon" viewBox="0 0 20 20">
          ...
          <input type="text" placeholder="Item Name" value={title} onChange={updateTitle}></input>
        </div>
        ...
        <svg class="svg-icon" viewBox="0 0 20 20">
          ...
          <input type="num" placeholder="Asking Price" value={price} onChange={updatePrice}></input>
        </div>
        ...
        <button type="submit" className="signin-bttn">Post</button>
        <br />
        <br />
      </form>
    </div>
