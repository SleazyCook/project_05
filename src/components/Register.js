        ...
        <div id="register-container">
            ...
            <form className="form" onSubmit={formSubmitHandler}>
                ...
                {/* <label>Enter New Username Here: </label> */}
                    ...
                    <input type="text" value={username} onChange={updateUserNameState} placeholder="New Username"></input>
                </div>
                ...
                <div className="password">
                    ...
                    <input type="password" value={password} onChange={updatePasswordState} placeholder="New Password"></input>
                </div>

                <button className="signin-bttn" type="submit">Register</button>
            </form>
            <br />
        </div>
    )
